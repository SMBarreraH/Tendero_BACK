<?php
    ...
    $id_rn_idpersona=$_GET['id_rn_idpersona'];
    $id_rn_orden=$_GET['id_rn_orden'];
    $rn_tiponoti=$_GET['rn_tiponoti'];
    $rn_descnoti=$_GET['rn_descnoti'];

         $data = array(
                  'title' => $rn_tiponoti,
                  'body' => $rn_descnoti,
                  );
     $consulta="CALL sp_a_registrar_notificacion_mensaje_soporte('".$id_rn_idpersona."','".$id_rn_orden."','".$rn_tiponoti."','".$rn_descnoti."')";
